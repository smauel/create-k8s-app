...
function tryGitInit(appPath) {
  ...
  try {
    ...
    execSync('git commit -m "Initial commit from Create Kubernetes App"', {
      stdio: 'ignore',
    });
    return true;
  } catch (e) {
...
module.exports = function init(
  ...
  appPackage.scripts = {
    start: 'k8s-scripts start',
    build: 'k8s-scripts build',
    test: 'k8s-scripts test',
    eject: 'k8s-scripts eject',
  };
